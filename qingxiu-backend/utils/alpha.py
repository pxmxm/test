...
def pyMuPDF_file(pdfPath):
    ...
    for pg in range(pdfDoc.pageCount):
        ...
        zoom_x = 4.0  # 设置图片相对于PDF文件在X轴上的缩放比例
        zoom_y = 4.0  # 设置图片相对于PDF文件在Y轴上的缩放比例
...
def demo():
    appcode = '6c76a19a1ef745c0afb16fc8a8fccf61'
    url = 'https://ocrcard.market.alicloudapi.com/textread'
    img_base64 = pyMuPDF_file('http://39.107.75.182:19000/file/112633949924.pdf')
    # img_base64 =pyMuPDF_file('http://39.107.75.182:19000/file/145110322289.pdf')
